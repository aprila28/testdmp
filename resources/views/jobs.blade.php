                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>
                                        ...
                                        <button type="button" class="btn btn-primary detailbyid" data-id="{{$data['job_id']}}">Show Detail</button>
                                        <p class="source">
...
<script>
    $(document).ready(function() {
        $('#search').click(function() {
            window.location.href = "{{url('job-by')}}/" + $('#description_field').val() + "&" + $('#location_field').val();
